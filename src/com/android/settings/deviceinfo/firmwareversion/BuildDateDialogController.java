...
public class BuildDateDialogController {
    ...
    private final static String X_BUILD_DATE_PROP = "ro.build.date";
	...
	String build_date_prop = SystemProperties.get(X_BUILD_DATE_PROP);
	String build_date = SystemProperties.get(X_BUILD_DATE_PROP).substring(0,10).trim();
	String build_year = SystemProperties.get(X_BUILD_DATE_PROP).substring(build_date_prop.length() - 4).trim();
