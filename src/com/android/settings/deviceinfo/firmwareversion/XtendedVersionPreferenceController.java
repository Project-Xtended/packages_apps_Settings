...
public class XtendedVersionPreferenceController extends BasePreferenceController {
    ...
    public int getAvailabilityStatus() {
        return !TextUtils.isEmpty(SystemProperties.get(XTENDED_VERSION_PROPERTY)) ? AVAILABLE : UNSUPPORTED_ON_DEVICE;
    }

    @Override
    public CharSequence getSummary() {
        return SystemProperties.get(XTENDED_VERSION_PROPERTY,
